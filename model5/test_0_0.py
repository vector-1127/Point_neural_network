...
c_0 = Activation('relu')(c_0)

#c_0 = GumbelSoftmax(temperature=0.1, hard = False)(c_0)
i_0 = GumbelSoftmax(temperature=0.1, hard = True)(c_0)
for _ in range(0):
    i_0_t = GumbelSoftmax(temperature=0.1, hard = True)(c_0)
...
i_1 = GumbelSoftmax(temperature=0.1, hard = True)(c_1)
for _ in range(0):
    i_1_t = GumbelSoftmax(temperature=0.1, hard = True)(c_1)
...
i_2 = GumbelSoftmax(temperature=0.1, hard = True)(c_2)
for _ in range(0):
    i_2_t = GumbelSoftmax(temperature=0.1, hard = True)(c_2)
