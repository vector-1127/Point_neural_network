...
in_1 = BatchNormalization()(in_1)
in_1 = Dense(64 * 64, weights=[np.zeros([256, 64 * 64]), np.eye(64).flatten().astype(np.float32)])(in_1)
feature_T1 = Reshape((64, 64))(in_1)
in_1 = MatMul()([out_0, feature_T1])


# forward net1
f_1 = Conv1D(256, 1, activation='relu')(in_1)
f_1 = BatchNormalization()(f_1)
f_1 = Conv1D(256, 1, activation='relu')(f_1)
f_1 = BatchNormalization()(f_1)
c_1 = Conv1D(32, 1, activation='relu')(out_0)
c_1 = BatchNormalization()(c_1)
c_1 = Conv1D(32, 1, activation='relu')(c_1)
c_1 = BatchNormalization()(c_1)
i_1 = Activation('hard_sigmoid')(c_1)
...
''''''
global_feature = MaxPooling1D(pool_size=32)(out_1)
...
'''
model = Model(inputs=input_points, outputs=[in_1])
