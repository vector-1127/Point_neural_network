...
gt = Conv1D(32, 1, activation='relu')(g_0)
gt = BatchNormalization()(gt)
gt = Conv1D(64, 1, activation='relu')(gt)
gt = BatchNormalization()(gt)
gt = Conv1D(32, 1, activation='relu')(gt)
gt = BatchNormalization()(gt)
gt = Conv1D(3, 1, activation='relu')(gt)
gt = BatchNormalization()(gt)


g_1 = Add()([g_0, gt])
g = Conv1D(64, 1, activation='relu')(g_1)
