...
from data_loader import DataGenerator
from model import MatMul, mySign, myConv, myAgg, GumbelSoftmax
...
g_0 = Conv1D(64, 1, activation='relu', 
                    kernel_initializer='zeros', bias_initializer='zeros')(g_0)
g_0_ = Conv1D(64, 1, activation='relu')(g_0)
prediction = GumbelSoftmax(1, hard = True)(g_0)
