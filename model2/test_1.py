...
from data_loader import DataGenerator
from model import GumbelSoftmax, MatMul
...
c_0 = Conv1D(512, 1, activation='relu')(in_0)
c_0 = Conv1D(512, 1, activation='relu')(c_0)
out_0 = GumbelSoftmax(1, hard = False)([f_0, c_0])


# forward net1
f_1 = Conv1D(128, 1, activation='relu')(out_0)
f_1 = Conv1D(128, 1, activation='relu')(f_1)
c_1 = Conv1D(128, 1, activation='relu')(out_0)
c_1 = Conv1D(128, 1, activation='relu')(c_1)
out_1 = GumbelSoftmax(1, hard = False)([f_1, c_1])


# forward net2
f_2 = Conv1D(256, 1, activation='relu')(out_1)
f_2 = Conv1D(256, 1, activation='relu')(f_2)
c_2 = Conv1D(32, 1, activation='relu')(out_1)
c_2 = Conv1D(32, 1, activation='relu')(c_2)
out_2 = GumbelSoftmax(1, hard = False)([f_2, c_2])


# forward net3
f_3 = Conv1D(512, 1, activation='relu')(out_2)
f_3 = Conv1D(512, 1, activation='relu')(f_3)
c_3 = Conv1D(8, 1, activation='relu')(out_2)
c_3 = Conv1D(8, 1, activation='relu')(c_3)
out_3 = GumbelSoftmax(1, hard = False)([f_3, c_3])


# forward net4
f_4 = Conv1D(512, 1, activation='relu')(out_3)
f_4 = Conv1D(512, 1, activation='relu')(f_4)


global_feature = MaxPooling1D(pool_size=8)(f_4)
