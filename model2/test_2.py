...
out_0 = GumbelSoftmax(nb_batch=32, temperature=1, hard = True)([f_0, c_0])


'''
global_feature = MaxPooling1D(pool_size=32)(out_0)
...
model = Model(inputs=input_points, outputs=[out_0])
